...
// Verificar se usuário está logado - Suportar SESSION e JWT
$usuario = viabixGetAuthenticatedUser();
if (!$usuario) {
    header('Location: ../login.html');
    exit;
}

// Sincronizar SESSION com dados do usuário autenticado (SESSION ou JWT)
